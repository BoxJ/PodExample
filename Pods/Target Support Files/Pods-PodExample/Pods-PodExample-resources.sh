...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/HappyDNS/HappyDNS.privacy.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/JMBoomSDKBase/JMBoomSDKBase.bundle"
  ...
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/Qiniu/Qiniu.privacy.bundle"
