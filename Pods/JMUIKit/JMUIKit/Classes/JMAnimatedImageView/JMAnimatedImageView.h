...
@class JMAnimatedImage;
@protocol JMAnimatedImageViewDebugDelegate;


//
//  An `JMAnimatedImageView` can take an `JMAnimatedImage` and plays it automatically when in view hierarchy and stops when removed.
...
@property (nonatomic, strong) JMAnimatedImage *animatedImage;
